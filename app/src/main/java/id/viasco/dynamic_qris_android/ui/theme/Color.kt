...
// Fallback palette (used on Android 11 and below, or when dynamic color disabled)
// Teal-based — matches QRIS brand identity, generated via Material Theme Builder
...
// Status colors (semantic — for transaction status badges, not theme-bound)
val StatusSuccess = Color(0xFF2E7D32)
val StatusSuccessContainer = Color(0xFFC8E6C9)
val StatusPending = Color(0xFFE65100)
val StatusPendingContainer = Color(0xFFFFE0B2)
val StatusExpired = Color(0xFF616161)
val StatusExpiredContainer = Color(0xFFE0E0E0)
val StatusCancelled = Color(0xFFC62828)
val StatusCancelledContainer = Color(0xFFFFCDD2)
